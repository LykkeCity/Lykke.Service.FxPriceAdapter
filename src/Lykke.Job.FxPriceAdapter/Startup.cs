...
using Lykke.Job.FxPriceAdapter.Settings;
using Lykke.Job.FxPriceAdapter.Modules;
using Lykke.Logs;
...
namespace Lykke.Job.FxPriceAdapter
{
    [PublicAPI]
    public class Startup
    {
        private const string ApiVersion = "v1";
        private const string ApiName = "FxPriceAdapterJob API";
        ...
        public IServiceProvider ConfigureServices(IServiceCollection services)
        {
            try
            {
                ...
                services.AddLykkeLogging(
                    settingsManager.ConnectionString(s => s.FxPriceAdapterJob.Db.LogsConnString),
                    "FxPriceAdapterJobLog",
                ...
                builder.RegisterModule(new JobModule(appSettings.FxPriceAdapterJob, settingsManager.Nested(x => x.FxPriceAdapterJob)));
